...
class subplansViewController: UIViewController, UIScrollViewDelegate, SKProductsRequestDelegate, SKPaymentTransactionObserver
{
...
override func viewDidLoad() {
   ...
   print( dateFormatter.string(from: thirtyDaysBeforeToday!))
    ...
    let button = UIBarButtonItem(title: "Setting", style: .done, target: self, action: #selector(back))
...
setupNavigationItem()
    ...
    self.navigationItem.leftBarButtonItem = sharebarButton
    ...
    scrollview.contentSize = CGSize(width: view.frame.width, height: 736 + 300)
