...
final class Theme {
    ...
    static let productName = "DorkVPN"
    static let brandName = "DorkVPN"

    static let forgotPasswordURL = "https://www.dorkvpn.com/portal/submitticket.php?step=2&deptid=1"
    static let contactSupportURL = "https://www.dorkvpn.com/portal/submitticket.php?step=2&deptid=1"

    static let usernameSuffix = "dorkvpn"
    static let apiKey = "fdb0afe76bce1805b156b5d1218853fc"
