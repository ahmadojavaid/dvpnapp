...
static NSString * const kUserLanguageEvent = @"User Language";
static NSString * const kProtocolEvent     = @"VPN Protocol";
...
static NSString * const kUserLanguageAttribute       = @"Language";
static NSString * const kProtocolAttribute           = @"Protocol";
