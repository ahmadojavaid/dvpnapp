...
/**
 * The API adapter is exposed for public use, but is readonly to prevent it from being reassigned.
 */
@property (atomic, readonly) NSObject <VPNAPIAdapterProtocol> * _Nonnull apiAdapter;
...
/*
 * Returns the current log level for the VPNAPIAdapter
 */
- (VPNLogLevel)logLevel;

/**
 * Sets the logging level for the VPNAPIManager
 *
 * @param level The log level to set
 */
- (void)setLogLevel:(VPNLogLevel)level;

/**
 * Clear the logs for the VPNAPIManager and all connection adapters.
 */
- (void)clearLogs;
